...
$MESS['HOLE_FIXED']           = 'отмечен факт исправления барьера';
...
$MESS['HOLE_REQUEST_FORM_ADDRESS']             = 'Адрес барьера';
$MESS['HOLE_REQUEST_FORM_COMMENT']             = 'Если барьер дороги представляет собой работающий в плохом режиме или неработающий светофор,';
...
$MESS['HOLE_REQUEST_FORM_ADDRESS_COMMENT']     = 'желательно указать адрес и месторасположение барьера как можно более точно';
...
$MESS['HOLE_REQUEST_FORM_SHOW_DESCRIPTIONS']            = 'Выводить описание барьера и описание местоположения';
$MESS['HOLE_REQUEST_FORM_SHOW_DESCRIPTIONS_COMMENT']            = 'Снимите отметку если не нужно выводить описания барьера и местоположения, указанные вами при добавлении барьера';
$MESS['HOLE_REQUEST_FORM_PRINT_PICTURES']            = 'Выводить изображения к барьерам';
...
$MESS['HOLE_CART_ADMIN_TEXT_7']  = 'Если барьер устранён';
$MESS['HOLE_CART_ADMIN_TEXT_8']  = 'Отметить как устранённый';
$MESS['HOLE_CART_ADMIN_TEXT_8a'] = 'Отметить барьер как устранённый';
$MESS['HOLE_CART_ADMIN_TEXT_9']  = '';
$MESS['HOLE_CART_ADMIN_TEXT_10'] = 'удалить';
$MESS['HOLE_CART_ADMIN_TEXT_11'] = 'Вы уверены, что хотите удалить этот барьер с сайта?';
...
$MESS['HOLE_CART_ADMIN_TEXT_16'] = 'Если барьер не устранён';
...
<p>Однако, учитывая наш опыт, по истечении 37 дней, в том случае, если барьер всё еще не устранён, а местные органы власти не желают принимать меры, мы предлагаем вам шаблон обращения в прокуратуру, который вы сможете дополнить или изменить с учетом вашей конкретной ситуации.</p>
<p>Данный шаблон <b>жалобы на бездействие местных органов</b> будет полезен в том случае, если Инспекция не ответила на ваше заявление, либо ответила, что барьер отсутствует и нет причин для принятия соответствующих мер, или сообщила, что повреждение устранено, но это не соответствует действительности.</p>';
...
$MESS['HOLE_PRESECUTOR_FORM_ADDRESS']                  = 'Адрес барьера';
