...
class Profile extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'send_achtung_notifications'=>'Присылать напоминания о просроченных запросах в органы власти',
			'show_archive_holes'=>'Показывать архивные барьеры в "Добавленных мной барьерах" и на "Моем участке"',
